...
const audienceOptions: {
  ...
  },
  {
    ...
    description: 'Direcione contatos com etiquetas específicas',
    icon: Tags,
  },
  {
    type: 'custom_field',
    label: 'Campo Personalizado',
    description: 'Filtre por um valor de campo personalizado',
    icon: Filter,
  },
  {
    type: 'csv',
    label: 'Importar CSV',
    description: 'Importe uma lista de números de telefone',
    icon: Upload,
  },
];
